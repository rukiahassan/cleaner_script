...
file_path = os.path.join(current_directory, 'cleaned_fencing_data.csv')  # Change the file name as needed.
...
if cleaned_dataset is not None:
    ...
    output_file_path = os.path.join(current_directory, 'structured_fencing_data.csv')  # rename to whatever fits best
